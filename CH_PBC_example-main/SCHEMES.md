## Scheme Index (Legacy Notes)

This file preserves the historical scheme list that originally lived in `README.md`.
It is **not** required to reproduce the TEE-RPCH artifact, but is kept for reference.
